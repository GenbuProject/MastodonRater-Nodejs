module.exports = {
	/** @param {Object} data */
	API_END: data => JSON.stringify(Object.assign({ state: module.exports.API_STATUS_SUCCEED }, data)),
	/** @param {Error} error */
	API_END_WITH_ERROR: error => JSON.stringify({ state: module.exports.API_STATUS_FAILED, error: error.message }),
